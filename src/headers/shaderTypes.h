...
namespace NShader
{
  ...
  enum EAttrib
  {
    ...
    ATTRIB_PNTTC_POSITION         = 0x0008,
    ATTRIB_PNTTC_NORMAL           = 0x0010,
    ATTRIB_PNTTC_NORMAL_TANGENT   = 0x0020,
    //ATTRIB_PNTTC_NORMAL_BITANGENT = 0x0040,
    ATTRIB_PNTTC_TEX_COORD        = 0x0080,
    ATTRIB_PNTTC_COLOR            = 0x0100
  };
  ...
  static const uint32 PROGRAM_ATTRIBS_LIST[] =
  {
    ...
    ATTRIB_PT_POSITION,
    ATTRIB_PT_POSITION | ATTRIB_PT_TEX_COORD,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR, // vbo attribs pack:   pos, nor, tan, tex, col
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_NORMAL_TANGENT /*| ATTRIB_PNTTC_NORMAL_BITANGENT */| ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_NORMAL_TANGENT /*| ATTRIB_PNTTC_NORMAL_BITANGENT */| ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_NORMAL_TANGENT /*| ATTRIB_PNTTC_NORMAL_BITANGENT */| ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_NORMAL_TANGENT /*| ATTRIB_PNTTC_NORMAL_BITANGENT */| ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
    ATTRIB_PNTTC_POSITION | ATTRIB_PNTTC_NORMAL | ATTRIB_PNTTC_NORMAL_TANGENT /*| ATTRIB_PNTTC_NORMAL_BITANGENT */| ATTRIB_PNTTC_TEX_COORD | ATTRIB_PNTTC_COLOR,
