...
namespace NShader
{
  ...
  enum EUniforms
  {
    ...
    UNIFORM_TILE_INST                 = 0x00002000,
    UNIFORM_SHAD_TEX_SIZE             = 0x00004000,
    UNIFORM_SHAD_CLIPS                = 0x00008000,
    UNIFORM_LAMB_COLOR                = 0x00010000,
    UNIFORM_LAMB_PICK                 = 0x00020000,
    UNIFORM_LAMB_LPOS                 = 0x00040000,
    UNIFORM_LAMB_LPOS_INJECT          = 0x00080000,
    UNIFORM_LRAN_LCOL_LSPEC_FRAN_FCOL = 0x00100000,
    UNIFORM_GEOM_TEX_SIZE             = 0x00200000,
    UNIFORM_LPV_POS_TEXS_CELLS_PARAMS = 0x00400000
  };
  ...
  static const uint32 PROGRAM_UNIFORMS_LIST[] =
  {
    ...
    UNIFORM_MVP_SHAD,
    UNIFORM_MVP_SHAD,
    UNIFORM_MVP_SHAD_CASCADE | UNIFORM_TILE_SHAD | UNIFORM_TILE_INST,
    UNIFORM_MVP_SHAD_CASCADE | UNIFORM_TILE_SHAD | UNIFORM_TILE_INST,
    UNIFORM_MVP,
    UNIFORM_MVP,
    UNIFORM_MVP,
    ...
    UNIFORM_MVP | UNIFORM_MW | UNIFORM_MWNIT | UNIFORM_MVPSB | UNIFORM_CAM | UNIFORM_TYPE | UNIFORM_TILE_SHAD | UNIFORM_TILE_INST | UNIFORM_SHAD_CLIPS | UNIFORM_LAMB_LPOS | UNIFORM_LRAN_LCOL_LSPEC_FRAN_FCOL | UNIFORM_LPV_POS_TEXS_CELLS_PARAMS,
    UNIFORM_MVP | UNIFORM_MW | UNIFORM_MWNIT | UNIFORM_MVPSB | UNIFORM_CAM | UNIFORM_TYPE | UNIFORM_TILE_SHAD | UNIFORM_TILE_INST | UNIFORM_SHAD_CLIPS | UNIFORM_SHAD_TEX_SIZE | UNIFORM_LAMB_LPOS | UNIFORM_LRAN_LCOL_LSPEC_FRAN_FCOL | UNIFORM_LPV_POS_TEXS_CELLS_PARAMS,
    UNIFORM_MVP | UNIFORM_MW | UNIFORM_MWNIT | UNIFORM_CAM | UNIFORM_TYPE | UNIFORM_OPACITY | UNIFORM_LAMB_LPOS | UNIFORM_LRAN_LCOL_LSPEC_FRAN_FCOL | UNIFORM_LPV_POS_TEXS_CELLS_PARAMS,
    UNIFORM_MVP | UNIFORM_MW | UNIFORM_MWNIT | UNIFORM_MVPSB | UNIFORM_CAM | UNIFORM_TYPE | UNIFORM_TILE_SHAD | UNIFORM_TILE_INST | UNIFORM_SHAD_CLIPS | UNIFORM_LAMB_LPOS | UNIFORM_LRAN_LCOL_LSPEC_FRAN_FCOL | UNIFORM_LPV_POS_TEXS_CELLS_PARAMS,
    UNIFORM_MVP | UNIFORM_MW | UNIFORM_MWNIT | UNIFORM_MVPSB | UNIFORM_CAM | UNIFORM_TYPE | UNIFORM_TILE_SHAD | UNIFORM_TILE_INST | UNIFORM_SHAD_CLIPS | UNIFORM_SHAD_TEX_SIZE | UNIFORM_LAMB_LPOS | UNIFORM_LRAN_LCOL_LSPEC_FRAN_FCOL | UNIFORM_LPV_POS_TEXS_CELLS_PARAMS,
    UNIFORM_MVP | UNIFORM_MW | UNIFORM_MWNIT | UNIFORM_CAM | UNIFORM_TYPE | UNIFORM_OPACITY | UNIFORM_LAMB_LPOS | UNIFORM_LRAN_LCOL_LSPEC_FRAN_FCOL | UNIFORM_LPV_POS_TEXS_CELLS_PARAMS,
    ...
    UNIFORM_MVP_GEOM_CASCADE | UNIFORM_MW | UNIFORM_MWNIT | UNIFORM_TILE_GEOM | UNIFORM_TILE_INST | UNIFORM_TYPE,
