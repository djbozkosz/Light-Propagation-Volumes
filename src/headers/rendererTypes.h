...
namespace NRenderer
{
  enum EMode
  {
    ...
    MODE_LPV_PROPAGATION_GEOMETRY_GATHERING,
    MODE_LPV_PROPAGATION_GEOMETRY_SCATTERING,
    MODE_LPV_CLEAR_COMPUTE,
    MODE_LPV_INJECTION_COMPUTE,
    MODE_LPV_PROPAGATION_COMPUTE_GATHERING,
    MODE_LPV_PROPAGATION_COMPUTE_SCATTERING
  };
}
//------------------------------------------------------------------------------
struct SRenderMesh
