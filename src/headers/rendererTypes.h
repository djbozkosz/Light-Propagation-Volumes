...
namespace NRenderer
{
  enum EMode
  {
    ...
    MODE_SSLPV_CLEAR_GEOMETRY,
    MODE_SSLPV_INJECTION_GEOMETRY,
    MODE_SSLPV_PROPAGATION_GATHERING_GEOMETRY,
    MODE_SSLPV_PROPAGATION_SCATTERING_GEOMETRY,
    ...
    MODE_SSLPV_CLEAR_COMPUTE,
    MODE_SSLPV_INJECTION_COMPUTE,
    MODE_SSLPV_PROPAGATION_GATHERING_COMPUTE,
    MODE_SSLPV_PROPAGATION_SCATTERING_COMPUTE
  };
}
//------------------------------------------------------------------------------
struct SRenderMesh
